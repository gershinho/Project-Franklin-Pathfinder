...
import { FileText, Image as ImageIcon, Search, Pencil, Eye, Settings, User, LogOut, FileSearch, Shield, UploadCloud, Loader2, CheckCircle2, Check, X, Maximize2, Minimize2 } from "lucide-react";
        ...
        <AnimatePresence>
          {isSearching && (
            <motion.div
              ...
              style={{ gap: isWorkspaceVisible ? "3rem" : "0rem" }}
            >
              ...
              >
                ...
                <div className="bg-gray-50/50 rounded-2xl p-8 border border-gray-100 h-full min-h-[400px] shadow-sm relative overflow-hidden flex flex-col">
                  ...
                  <div className="flex-1 overflow-y-auto pr-4">
                    <p className="text-gray-700 leading-relaxed text-[15px] whitespace-pre-wrap">
                      {typedText || (isAsking ? "Thinking…" : "")}
                      {(isAsking || typedText.length < fullText.length) && (
                        <span className="inline-block w-1.5 h-4 ml-1 bg-[#306FB8] animate-pulse align-middle rounded-sm"></span>
                      )}
                    </p>
                  </div>
                </div>
